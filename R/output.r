...
output_alsfrs <- output_patient_ids |>
  ...
  transmute(
    ...
    alsfrs_language__4 = if_else(lenguaje == 4, 1, 0),
    alsfrs_language__3 = if_else(lenguaje == 3, 1, 0),
    alsfrs_language__2 = if_else(lenguaje == 2, 1, 0),
    alsfrs_language__1 = if_else(lenguaje == 1, 1, 0),
    alsfrs_language__0 = if_else(lenguaje == 0, 1, 0),
    alsfrs_salivation__4 = if_else(salivacion == 4, 1, 0),
    alsfrs_salivation__3 = if_else(salivacion == 3, 1, 0),
    alsfrs_salivation__2 = if_else(salivacion == 2, 1, 0),
    alsfrs_salivation__1 = if_else(salivacion == 1, 1, 0),
    alsfrs_salivation__0 = if_else(salivacion == 0, 1, 0),
    alsfrs_deglution__4 = if_else(deglucion == 4, 1, 0),
    alsfrs_deglution__3 = if_else(deglucion == 3, 1, 0),
    alsfrs_deglution__2 = if_else(deglucion == 2, 1, 0),
    alsfrs_deglution__1 = if_else(deglucion == 1, 1, 0),
    alsfrs_deglution__0 = if_else(deglucion == 0, 1, 0),
    alsfrs_writing__4 = if_else(escritura == 4, 1, 0),
    alsfrs_writing__3 = if_else(escritura == 3, 1, 0),
    alsfrs_writing__2 = if_else(escritura == 2, 1, 0),
    alsfrs_writing__1 = if_else(escritura == 1, 1, 0),
    alsfrs_writing__0 = if_else(escritura == 0, 1, 0),
    alsfrs_cutting_nopeg__4 = if_else(alsfrs_gast_use == 0 & cortar_sin_peg == 4, 1, 0),
    alsfrs_cutting_nopeg__3 = if_else(alsfrs_gast_use == 0 & cortar_sin_peg == 3, 1, 0),
    alsfrs_cutting_nopeg__2 = if_else(alsfrs_gast_use == 0 & cortar_sin_peg == 2, 1, 0),
    alsfrs_cutting_nopeg__1 = if_else(alsfrs_gast_use == 0 & cortar_sin_peg == 1, 1, 0),
    alsfrs_cutting_nopeg__0 = if_else(alsfrs_gast_use == 0 & cortar_sin_peg == 0, 1, 0),
    alsfrs_cutting_peg__4 = if_else(alsfrs_gast_use == 1 & cortar_con_peg == 4, 1, 0),
    alsfrs_cutting_peg__3 = if_else(alsfrs_gast_use == 1 & cortar_con_peg == 3, 1, 0),
    alsfrs_cutting_peg__2 = if_else(alsfrs_gast_use == 1 & cortar_con_peg == 2, 1, 0),
    alsfrs_cutting_peg__1 = if_else(alsfrs_gast_use == 1 & cortar_con_peg == 1, 1, 0),
    alsfrs_cutting_peg__0 = if_else(alsfrs_gast_use == 1 & cortar_con_peg == 0, 1, 0),
    alsfrs_clothing__4 = if_else(vestido == 4, 1, 0),
    alsfrs_clothing__3 = if_else(vestido == 3, 1, 0),
    alsfrs_clothing__2 = if_else(vestido == 2, 1, 0),
    alsfrs_clothing__1 = if_else(vestido == 1, 1, 0),
    alsfrs_clothing__0 = if_else(vestido == 0, 1, 0),
    alsfrs_bed__4 = if_else(cama == 4, 1, 0),
    alsfrs_bed__3 = if_else(cama == 3, 1, 0),
    alsfrs_bed__2 = if_else(cama == 2, 1, 0),
    alsfrs_bed__1 = if_else(cama == 1, 1, 0),
    alsfrs_bed__0 = if_else(cama == 0, 1, 0),
    alsfrs_walking__4 = if_else(caminar == 4, 1, 0),
    alsfrs_walking__3 = if_else(caminar == 3, 1, 0),
    alsfrs_walking__2 = if_else(caminar == 2, 1, 0),
    alsfrs_walking__1 = if_else(caminar == 1, 1, 0),
    alsfrs_walking__0 = if_else(caminar == 0, 1, 0),
    alsfrs_stairs__4 = if_else(subir_escaleras == 4, 1, 0),
    alsfrs_stairs__3 = if_else(subir_escaleras == 3, 1, 0),
    alsfrs_stairs__2 = if_else(subir_escaleras == 2, 1, 0),
    alsfrs_stairs__1 = if_else(subir_escaleras == 1, 1, 0),
    alsfrs_stairs__0 = if_else(subir_escaleras == 0, 1, 0),
    alsfrs_dyspnea__4 = if_else(disnea == 4, 1, 0),
    alsfrs_dyspnea__3 = if_else(disnea == 3, 1, 0),
    alsfrs_dyspnea__2 = if_else(disnea == 2, 1, 0),
    alsfrs_dyspnea__1 = if_else(disnea == 1, 1, 0),
    alsfrs_dyspnea__0 = if_else(disnea == 0, 1, 0),
    alsfrs_orthopnea__4 = if_else(ortopnea == 4, 1, 0),
    alsfrs_orthopnea__3 = if_else(ortopnea == 3, 1, 0),
    alsfrs_orthopnea__2 = if_else(ortopnea == 2, 1, 0),
    alsfrs_orthopnea__1 = if_else(ortopnea == 1, 1, 0),
    alsfrs_orthopnea__0 = if_else(ortopnea == 0, 1, 0),
    alsfrs_resp_failure__4 = if_else(insuficiencia_respiratoria == 4, 1, 0),
    alsfrs_resp_failure__3 = if_else(insuficiencia_respiratoria == 3, 1, 0),
    alsfrs_resp_failure__2 = if_else(insuficiencia_respiratoria == 2, 1, 0),
